...
class DashBoard extends StatelessWidget {
  ...
  final List<Map> tiktokVideos =[
    {
      "video": "assets/videos/video1.mov",
    },
     {
      "video": "assets/videos/video2.mov",
    },
     {
      "video": "assets/videos/video3.mov",
    },
     {
      "video": "assets/videos/video6.mov",
    },
     {
      "video": "assets/videos/video7.mov",
    },
     {
      "video": "assets/videos/video7.mov",
    },
...
class _VideosState extends State<Videos> {
  ...
  //cette partie permet d'executer du code au lancement de l'application
  @override
  void initState(){
    super.initState();
            ...
            child: Column(
              ...
              '#The meaning of forgiveness',
               ...
               style: TextStyle(
                ...
                const SizedBox(height: 10),
               const Text(
              '#People make mistakes, doesnt mean you have to give in',
                  ...
                  child: Stack(
                    ...
                    children:  [
                       Container(
                        ...
                        CircleAvatar(
                        radius: 25,
                        backgroundImage: AssetImage('assets/images/hedy.jpg'),
                        ),
                      ),
                      Container(
    ...
    Widget build(BuildContext context) {
      return AnimatedBuilder(
        ...
        child: Container(
          ...
          child: Image.asset('assets/images/hedy3.JPG'),
        ),
      );
  }
}